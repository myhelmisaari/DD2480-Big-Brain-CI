...
{
    public static final String gitHubRepoHTTPS = "https://github.com/myhelmisaari/DD2480-Big-Brain-CI.git";
    public static final String assessmentRepo = "assessmentDir/";
